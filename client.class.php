...
class Client
{
	private function CID_windows_detect_os($ua)
	{
	...
	private function CID_unix_detect_os($ua)
	{
	...
	private function CID_pda_detect_os($ua)
	{
		$os_name = $os_code = $os_ver  = $pda_name= $pda_code= $pda_ver = null;
	...
	* @return string 中文星期
	*/
	public function WeekNumber2Chinese($weekNumber = 0,$weekPrefix = "周")
	{
